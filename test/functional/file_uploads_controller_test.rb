...
class FileUploadsControllerTest < ActionController::TestCase
  ...
  test "should create file_upload" do
    assert_difference('FileUpload.count') do
      post :create, file_upload: { description: @file_upload.description, name: @file_upload.name, picture: @file_upload.picture }
    end
  ...
  test "should update file_upload" do
    put :update, id: @file_upload, file_upload: { description: @file_upload.description, name: @file_upload.name, picture: @file_upload.picture }
    assert_redirected_to file_upload_path(assigns(:file_upload))
  end
